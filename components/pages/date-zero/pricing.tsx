...
export function DateZeroPricing() {
  ...
  return (
    <section id="pricing" ref={ref} className="relative py-24 lg:py-32 bg-gradient-to-b from-black via-[#050505] to-black overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-[#AFECDB]/5 blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-6">
            ...
            >
              ...
              {tier.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10">
                  <span className="bg-[#AFECDB] text-black px-4 py-1 text-xs font-bold font-heading">
                    MOST POPULAR
                  </span>
                </div>
              )}
              ...
              <div
                className={`h-full bg-gradient-to-b from-[#1A1A1A] to-[#0D0D0D] border p-8 transition-all hover:shadow-xl ${
                  tier.popular
                    ? 'border-[#AFECDB]/50 shadow-lg shadow-[#AFECDB]/10'
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-3">
                    ...
                    <span className="text-4xl font-bold text-white font-body">
                      {tier.price}
                    </span>
                    <span className="text-white/40 text-sm">one-time</span>
                  </div>
                  <p className="text-white/60 text-sm font-body">{tier.description}</p>
                </div>
        ...
        <motion.div
          ...
          className="mt-8 text-center text-white/40 text-sm font-body"
        >
