      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-[#AFECDB]/20 to-[#AFECDB]/5 flex items-center justify-center"
          >
            <svg className="w-12 h-12 text-[#AFECDB]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 font-display">
            ...
            <span className="text-[#AFECDB]">ONE DECISION</span>
          </h2>

          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto font-body">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-body">New cohort starting soon</span>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              <svg className="w-8 h-8 text-[#AFECDB] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
              </svg>
              <div className="text-left">
                <p className="text-white font-semibold font-heading">Risk-Free Transformation Guarantee</p>
