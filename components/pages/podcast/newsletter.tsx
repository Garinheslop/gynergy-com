...
export function PodcastNewsletter() {
  ...
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://instagram.com/gynergy",
      icon: (
        ...
        >
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] rounded-3xl border border-[#2E2E2E] p-8 lg:p-12">
            ...
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[#F8F812]/10 border border-[#F8F812]/30 flex items-center justify-center">
              <svg className="w-10 h-10 text-[#F8F812]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex justify-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 rounded-lg bg-[#1A1A1A] border border-[#2E2E2E] flex items-center justify-center text-white/70 hover:border-[#F8F812]/30 hover:bg-[#F8F812]/10 hover:text-[#F8F812] transition-all"
                title={social.name}
              >
                {social.icon}
              </a>
