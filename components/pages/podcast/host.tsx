        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative aspect-square max-w-md mx-auto">
              {/* Decorative elements */}
              <div className="absolute -inset-4 bg-gradient-to-br from-[#AFECDB]/20 via-transparent to-[#AFECDB]/20 rounded-2xl blur-xl" />
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-[#1A1A1A] to-black">
                <div className="aspect-square bg-gradient-to-br from-[#1A1A1A] via-[#0D0D0D] to-black flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#AFECDB]/20 to-[#AFECDB]/20 flex items-center justify-center">
                      <svg className="w-16 h-16 text-[#AFECDB]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 bg-[#AFECDB] text-black px-5 py-2 rounded-full font-bold text-sm"
              >
                New Episode Weekly
              </motion.div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                {topics.map((topic, index) => (
                  ...
                  >
                    <div className="w-1.5 h-1.5 rounded-full bg-[#AFECDB]" />
                    {topic}
                  </motion.div>
                ))}
              </div>
