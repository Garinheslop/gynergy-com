...
export function NewsletterSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 lg:py-32 bg-black overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/2 left-0 w-64 h-64 bg-[#AFECDB]/10 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2" />
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] border border-[#2E2E2E] p-8 lg:p-12 relative overflow-hidden">
            {/* Inner glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#AFECDB]/5 rounded-full blur-3xl -translate-y-1/2" />
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <span className="w-5 h-5 bg-[#AFECDB]/20 flex items-center justify-center">
                        <svg className="w-3 h-3 text-[#AFECDB]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                {/* Trust indicators */}
                <div className="mt-6 flex items-center justify-center gap-4 text-white/40 text-xs font-body">
            ...
            <div className="absolute top-0 right-0 w-24 h-24 border-t border-r border-[#AFECDB]/20" />
        ...
        >
          <p className="text-white/40 text-sm font-body">
            ...
            <span className="text-[#AFECDB]">mastering the self to serve the world</span>
          </p>
        </motion.div>
      </div>
    </section>
